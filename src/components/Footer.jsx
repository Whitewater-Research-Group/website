  ...
  return (
    <footer className="bg-gray-900 text-white py-12 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-10">
        ...
        <svg
          className="absolute -top-20 -right-20 w-64 h-64 transform rotate-45"
          viewBox="0 0 100 100"
        >
          <circle
            cx="50"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-28s">
          <div className="lg:col-span-4">
            <div className="relative">
              <h4
                className="font-primary text-4xl font-bold mb-6 relative"
            ...
            <p className="text-gray-300 font-manrope text-sm leading-relaxed mb-6">
              White Water Research Group (WWRG) is a multidisciplinary research
              organization focusing on advancing health surveillance, data
              privacy, and low-tech stakeholder engagement. Our mission is to
              create solutions that addresses the challenges faced by human,
          ...
          <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="relative">
              <h4
                className="text-xl font-manrope font-bold mb-6 flex items-center gap-2"
                style={{ color: brandColor }}
              >
                Company
                <svg
      ...
      <div className="border-t border-gray-700 mt-12 pt-6">
        <div className="container mx-auto px-6 md:px-12 lg:px-20 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <p className="text-gray-500 text-sm text-center md:text-left">
            &copy; {new Date().getFullYear()} White Water Research Group. All
            rights reserved.
          </p>
