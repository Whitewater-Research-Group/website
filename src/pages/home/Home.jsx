    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center py-24 lg:py-32 overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-black/80 via-black/80 to-black/80 lg:from-black/60 lg:via-black/60 lg:to-black/60" />
        </div>
      ...
      <Researches />
      <WhyChooseUs />
      <div className="bg-gradient-to-r from-[#CD5E49] to-[#E07A5F] text-white p-6 mb-8 rounded-lg shadow-lg max-w-3xl mx-auto mt-6">
        <div className="text-center">
          <h2 className="text-2xl font-bold mb-4">
            📢 Don't Miss Out on Our Upcoming Conference!
          </h2>
          <p className="text-lg mb-6">
            Join thought leaders, innovators, and experts as we explore
            groundbreaking solutions to today's challenges.
          </p>
          <a
            href="/events"
            className="group inline-flex items-center px-6 py-3 bg-white/10 text-white rounded-lg 
