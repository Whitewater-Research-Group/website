...
<section className="relative py-16 px-4 lg:px-16 bg-gradient-to-r from-purple-700 to-indigo-900 text-white text-center lg:text-left">
  ...
  <div className="relative z-10 max-w-4xl mx-auto">
    ...
    <div className="mt-8">
      <a href="#contact" className="bg-turquoiseBlue hover:bg-cyan-500 text-white font-semibold text-lg lg:text-xl rounded-full px-6 py-3 transition duration-300">
